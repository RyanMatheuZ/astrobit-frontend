...
const PartnerTitle = () => (
  <Typography
    component="h2"
    sx={{
      color: 'primaryColor', fontSize: { xs: '26px', md: '34px' }, fontFamily: 'Montserrat', fontWeight: 700, textAlign: 'center', mb: 3,
    }}
  >
    Parceiros
  </Typography>
...
const PartnerLogos = () => (
  <Box sx={{
    display: 'flex', flexWrap: 'wrap', justifyContent: 'center', alignItems: 'center', my: 5,
  }}
  >
    {logos.map((logo) => (
      <Box
