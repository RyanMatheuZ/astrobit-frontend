...
const Info = ({ icon, text }) =>
  <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, alignItems: 'center', justifyContent: 'center', my: 2 }}>
    <img
    ...
    <Typography sx={{ fontSize: { xs: '14px', md: '16px' }, textAlign: { xs: 'center', md: 'left' }, ml: { xs: 0, md: 2 }, width: { xs: '60%', md: '50%' } }}>
      {text}
    </Typography>
  </Box>
