...
const Login = () => {
  ...
  return (
    ...
    <Box sx={{ bgcolor: 'white', borderLeft: 3, borderColor: 'tertiaryColor', borderTopRightRadius: '20px', borderBottomLeftRadius: '20px', boxShadow: 6, cursor: 'default', margin: '0 auto', maxWidth: '400px',fontFamily: 'Montserrat'}}>
